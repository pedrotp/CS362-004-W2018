 ...
 * **
 * ** This tests card: great_hall
 * **
 * ** Card effects: +1 card, +1 actions
 * ** Test for +1 card, +1 actions, card must come from own pile, piles
